...
import img1 from "../../images/children/PencilSet.png";
...
const PencilSet = () => {
    ...
    const saveProUser = (e) =>{
        ...
        const prouser={userName:"kiran@111",proName:"PencilSet",proQty,proPrice:"90"}
    ...
    return (
        <div>
            <div className="items">
                    ...
                    <img img src={img1} alt="PencilSet" />
