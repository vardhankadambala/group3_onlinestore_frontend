...
import img1 from "../../images/children/GeometryBox.png";
...
const GeometryBox = () => {
    ...
    const saveProUser = (e) =>{
        ...
        const prouser={userName:"kiran@111",proName:"GeometryBox",proQty,proPrice:"150"}
    ...
    return (
        <div>
            <div className="items">
                    ...
                    <img img src={img1} alt="GeometryBox" />
