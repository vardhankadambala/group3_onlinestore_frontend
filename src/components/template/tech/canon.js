...
import img1 from "../../images/tech/CanonCamera.png";
...
const Canon = () => {
    ...
    const saveProUser = (e) =>{
        ...
        const prouser={userName:"kiran@111",proName:"CanonCamera",proQty,proPrice:"70000"}
    ...
    return (
        <div>
            <div className="items">
                    ...
                    <img img src={img1} alt="CanonCamera" />
